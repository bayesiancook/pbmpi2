...
void RASCATGammaPhyloProcess::FastReadTopoBF2(string name, int burnin, int every, int until, double prop)	{
...
void RASCATGammaPhyloProcess::ReadTopoBF2(string name, int burnin, int every, int until, double prop)	{
