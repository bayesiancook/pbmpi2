...
void AACodonMutSelSiteOmegaFinitePhyloProcess::SlaveUpdateParameters()	{
	...
	// codonprofile
	// 1 for omega
	nd = nbranch + nnucrr + nnucstat + L1*L2 + GetDim() + nstate + ProfileProcess::GetNsite() + 2;
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::SlaveExecute(MESSAGE signal)	{
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::GlobalUpdateParameters() {
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::SlaveComputeCVScore()	{
	...
	for (int k=0; k<GetNcomponent(); k++)	{
		for (int i=sitemin; i<sitemax; i++)	{
			AACodonMutSelSiteOmegaFiniteProfileProcess::alloc[i] = k;
		}
		UpdateComponent(k);
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::ReadPB(int argc, char* argv[])	{
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::ReadMapStats(string name, int burnin, int every, int until){
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::Read(string name, int burnin, int every, int until)	{
}

int AACodonMutSelSiteOmegaFinitePhyloProcess::CountNonSynMapping()	{
...
int AACodonMutSelSiteOmegaFinitePhyloProcess::CountNonSynMapping(int i)	{
	int count = 0;
...
int AACodonMutSelSiteOmegaFinitePhyloProcess::GlobalNonSynMapping()	{
...
void AACodonMutSelSiteOmegaFinitePhyloProcess::SlaveNonSynMapping()	{
