...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::SlaveUpdateParameters()	{
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::SlaveExecute(MESSAGE signal)	{
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::GlobalUpdateParameters() {
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::SlaveComputeCVScore()	{
	...
	for (int k=0; k<GetNcomponent(); k++)	{
		for (int i=sitemin; i<sitemax; i++)	{
			AACodonMutSelSiteOmegaSBDPProfileProcess::alloc[i] = k;
		}
		UpdateComponent(k);
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::ReadPB(int argc, char* argv[])	{
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::ReadMapStats(string name, int burnin, int every, int until){
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::Read(string name, int burnin, int every, int until)	{
}

int AACodonMutSelSiteOmegaSBDPPhyloProcess::CountNonSynMapping()	{
...
int AACodonMutSelSiteOmegaSBDPPhyloProcess::CountNonSynMapping(int i)	{
	int count = 0;
...
int AACodonMutSelSiteOmegaSBDPPhyloProcess::GlobalNonSynMapping()	{
...
void AACodonMutSelSiteOmegaSBDPPhyloProcess::SlaveNonSynMapping()	{
