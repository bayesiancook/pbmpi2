...
class PhyloProcess : public virtual SubstitutionProcess, public virtual BranchProcess {
	...
	*/
	...
	virtual void ReadSiteProfiles(string name, int burnin, int every, int until, double cialpha, string trueprofiles);
	virtual void ReadProfileDistribution(string name, int burnin, int every, int until);
